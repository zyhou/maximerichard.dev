...
-   [colorls](https://github.com/athityakumar/colorls) pour améliorer l'affichage de `ls`.
-   [fd > find](https://github.com/sharkdp/fd) qui a des arguments plus simples à retenir que `find`.
-   `tree` pour afficher l'arborescence d'un dossier.
